...
public class PayrollSystemTest {
   public static void main(String[] args) {
      ...
      for(int i = 1; i <= 12; i++){
         System.out.println("Employee details in month " + i + "\n");
         for (Employee currentEmployee : employees) {
            ...
            double currentEmployeeEarnings = i == currentEmployee.getBirthDate().getMonth() ? currentEmployee.earnings() + 100 : currentEmployee.earnings();
            System.out.printf("earned $%,.2f%n%n",currentEmployeeEarnings);
         } 
         System.out.println();
      }
