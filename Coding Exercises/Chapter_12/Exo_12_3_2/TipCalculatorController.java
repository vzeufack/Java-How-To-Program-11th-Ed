...
public class TipCalculatorController { 
   ...
   @FXML
   private TextField numOfPersonsTextField;
   ...
   private void calculateButtonPressed(ActionEvent event) {
      try {
         ...
         BigDecimal numberOfPersons = new BigDecimal(numOfPersonsTextField.getText());
         BigDecimal tip = amount.multiply(tipPercentage);
         BigDecimal total = amount.add(tip);
         MathContext mc = new MathContext(2, RoundingMode.UP);
         BigDecimal totalPerPerson = total.divide(numberOfPersons, mc);
