...
public class SimpletronSimulator{
    ...
    private static void executeSMLProgram(){
        ...
        final int REMAINDER = 34; //computes the remainder of the division of a word from a specific location in memory into the word in the accumulator
        final int EXPONENT = 35;  //raises a word from a specific location in memory to the power of the word in the accumulator
        final int BRANCH = 40;
